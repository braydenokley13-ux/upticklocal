...
Audited against the current 56-second master and its product fixture. This audit does
...
|---|---|---|
| Uptick runs promotions on indoor TVs at local businesses and uses them to build a merchant's audience | The user's product thesis | The film's central proposition, stated at 0:03 and paid off at 0:53. Real-world product availability, install base and partner agreements are not independently verified here. |
...
| **Joe's promotion on the car-wash TV** | A generated indoor waiting room with an ordinary landscape wall-mounted TV; exact offer content is drawn in Remotion and mapped to its measured display corners | The black bezel, wall shadow, waiting chairs and wash-bay viewing window establish a normal indoor display. It illustrates Uptick running on existing-looking business TVs, not an outdoor sign or proprietary hardware. AI-generated concept imagery, not a documented installation. |
...
| The customer notices the offer | New five-second Higgsfield motion, source frames [0,114) used continuously from 6.00–10.75 s | Seated in the car-wash waiting room, he lifts his head from the phone on his lap and looks toward the TV. The following close-up shows the exact offer on that same TV. Rear/three-quarter view preserves customer continuity. |
