...
export const SHOTS: ShotDef[] = [
  ...
  { id: "Hero5B", index: 5, variant: "B", name: "Return → the morning builds → the proof", line: "Four physical beats and the light doing the talking; then the line the store stands on becomes the rule the 21 stands on.", seconds: ACT9_FRAMES / 24, frames: ACT9_FRAMES, proves: "digital → physical → measurable", component: Act9Return },
