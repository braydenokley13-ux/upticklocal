...
export const SHOTS: ShotDef[] = [
  ...
  { id: "Hero4", index: 4, name: "Does diesel count? → provenance", line: "Answered automatically, from the approved details, visibly.", seconds: 10, proves: "grounded, not invented", component: Hero4 },
