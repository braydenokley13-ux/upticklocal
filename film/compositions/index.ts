...
export const SHOTS: ShotDef[] = [
  ...
  { id: "Hero5", index: 5, variant: "A", name: "Offer → Pass → Redeem now", line: "The same slab becomes the pass; it goes into a pocket and through the door; at the counter, two taps, and the block becomes the live redeemed state.", seconds: ACT8_FRAMES / 24, frames: ACT8_FRAMES, proves: "redemption without merchant work", component: Act8Redeem },
